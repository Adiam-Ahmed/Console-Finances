...
for (let index = 1; index < finances.length; index++) {
  ...
  if (change > maxIncrease) {
    maxIncrease = change;
    maxIncreaseDate = finances[index][0];
  }
  if (change < maxDecrease){
    maxDecrease= change;
    maxDecreaseDate=finances[index][0]
  }
};
...
console.log(maxIncrease+" "+maxIncreaseDate)
console.log(maxDecreaseDate+" "+maxDecrease)

document.getElementById("total").innerHTML = `Total: $${total}`;
document.getElementById("months").innerHTML = `Number of months: ${months}`;
